...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202408111906-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  00-mysqld.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Aug 11, 2024 19:06 EDT
# @@File             :  00-mysqld.sh
# @@Description      :
...
DATABASE_DIR="${DATABASE_DIR_MYSQL:-$DATABASE_BASE_DIR/mysql}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set webroot
WWW_ROOT_DIR="/usr/share/httpd/default"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Default predefined variables
DATA_DIR="/data/mysql"   # set data directory
CONF_DIR="/config/mysql" # set config directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
VAR_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/mysql"       # set the temp dir
RUN_DIR="/run/mysql"       # set scripts pid dir
LOG_DIR="/data/logs/mysql" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
SERVICE_GROUP="mysql" # Set the service group
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
root_user_name="${MYSQL_ROOT_USER_NAME:-}" # root user name
root_user_pass="${MYSQL_ROOT_PASS_WORD:-}" # root user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
user_name="${MYSQL_USER_NAME:-}"      # normal user name
user_pass="${MYSQL_USER_PASS_WORD:-}" # normal user password
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
[ -f "/config/env/mysql.script.sh" ] && . "/config/env/mysql.script.sh" # Generated by my dockermgr script
[ -f "/config/env/mysql.sh" ] && . "/config/env/mysql.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Additional predefined variables

# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Additional variables
BLOWFISH_SECRET="$(__random_password 32)"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # replace variables
  __replace "REPLACE_BLOWFISH_SECRET" "$BLOWFISH_SECRET" "/etc/phpmyadmin/config.php"
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # define actions
