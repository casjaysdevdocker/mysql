...
# command arguments
EXEC_CMD_ARGS='--user=$SERVICE_USER --datadir=$DATABASE_DIR'
...
# root user name
root_user_name="${MYSQL_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${MYSQL_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${MYSQL_USER_NAME:-}"
# normal user password
user_pass="${MYSQL_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/mysql.script.sh" ] && . "/config/env/mysql.script.sh"
# Overwrite the variabes
[ -f "/config/env/mysql.sh" ] && . "/config/env/mysql.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
