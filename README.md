...
```shell
dockerHome="/srv/$USER/docker/casjaysdevdocker/mysql/mysql/latest/rootfs"
mkdir -p "/srv/$USER/docker/mysql/rootfs"
...
services:
  ProjectName:
    ...
    environment:
      ...
      - HOSTNAME=mysql
    volumes:
      - "/srv/$USER/docker/casjaysdevdocker/mysql/mysql/latest/rootfs/data:/data:z"
      - "/srv/$USER/docker/casjaysdevdocker/mysql/mysql/latest/rootfs/config:/config:z"
    ports:
      - 80:80
    restart: always
```
